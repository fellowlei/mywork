...
import com.mark.frame.http.core.HttpRequest;
import com.mark.frame.http.core.UserHttpMethod;
import com.mark.frame.http.lagou.LagouResult;
import com.mark.frame.http.lagou.Result;
...
public class LagouHttpTestUtil implements UserHttpMethod {
    ...
    public static void batchQuery() {
        ...
        for (int i = 1; i < 10; i++) {
            ...
            LagouResult lagouResult = FastJsonUtils.fromJson(result, LagouResult.class);
